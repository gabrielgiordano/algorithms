...
public class KdTree {
                           ...
                           double xmin, double ymin, double xmax, double ymax)
   {
      ...
      StdDraw.point(node.point.x() * 0.95 + 0.025, node.point.y() * 0.95 + 0.025);

      StdDraw.setPenRadius(0.0025);

      if (node.orientation == X) {
         StdDraw.setPenColor(StdDraw.RED);
         StdDraw.line(node.point.x() * 0.95 + 0.025, ymin * 0.95 + 0.025, node.point.x() * 0.95 + 0.025, ymax * 0.95 + 0.025);
         ...
         StdDraw.line(xmin * 0.95 + 0.025, node.point.y() * 0.95 + 0.025, xmax * 0.95 + 0.025, node.point.y() * 0.95 + 0.025);
                              ...
                              double xmin, double ymin, double xmax, double ymax)
   {
      ...
      if (node.orientation == X) {
         if (p.x() < node.point.x()) {
            ...
            recDistance = recAux.distanceTo(p);
